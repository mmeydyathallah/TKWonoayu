...
{{-- TOP BAR --}}
<header class="bg-white/90 backdrop-blur-2xl sticky top-0 z-30 border-b border-slate-100 shadow-sm flex items-center justify-between px-8 py-4 w-full -mx-8 mb-8 docked full-width">
...
<div class="max-w-7xl mx-auto w-full pb-32">
    ...
    <div class="flex flex-col gap-8">
        ...
        <div class="w-full">
            ...
            <div class="mb-6 flex items-center gap-4 bg-white rounded-2xl border border-slate-100 ambient-shadow px-5 py-3.5">
