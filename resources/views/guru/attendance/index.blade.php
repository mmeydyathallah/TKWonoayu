                                ...
                                <td class="px-5 py-4">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <span class="attendance-status-chip mt-1 inline-flex items-center gap-1 rounded-full bg-base-200 px-2 py-0.5 text-[10px] font-black uppercase tracking-wider" style="color: #020617 !important; background: rgba(248, 250, 252, 0.94) !important;">
